...
class TagNormalizationTest(unittest.TestCase):
    def test_required_spellings_share_one_canonical_definition(self) -> None:
        self.assertEqual(normalize_tag("ユーザインタフェース"), "ユーザインターフェース")
        self.assertEqual(normalize_tag("クライアント・サーバシステム"), "クライアントサーバシステム")
        self.assertEqual(
    ...
    def test_generated_filter_displays_canonical_tags_and_embeds_legacy_aliases(self) -> None:
        ...
        self.assertIn('data-facet-value="ユーザインターフェース"', html)
        self.assertIn('data-facet-value="クライアントサーバシステム"', html)
        self.assertNotIn('data-facet-value="ユーザインタフェース"', html)
